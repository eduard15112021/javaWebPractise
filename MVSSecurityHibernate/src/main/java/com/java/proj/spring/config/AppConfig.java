package com.java.proj.spring.config;
...
import com.java.proj.spring.model.Authorities;
...
@ComponentScans(value = { @ComponentScan("com.java.proj.spring.dao"),
        @ComponentScan("com.java.proj.spring.service") })
